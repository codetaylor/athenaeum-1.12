...
public class ModuleMaterials {
  ...
  // @formatter:off
  public static final Item.ToolMaterial FLINT = EnumHelper.addToolMaterial("artisanworktables:FLINT", 1, 150, 3.8f, 1.0f, 5);
  public static final Item.ToolMaterial BONE = EnumHelper.addToolMaterial("artisanworktables:BONE", 1, 150, 3.8f, 1.0f, 5);
