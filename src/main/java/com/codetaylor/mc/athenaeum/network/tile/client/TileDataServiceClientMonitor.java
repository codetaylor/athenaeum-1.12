...
public class TileDataServiceClientMonitor {
  ...
  private static final CacheLoader<BlockPos, TileDataServiceClientMonitor> CACHE_LOADER = new CacheLoader<BlockPos, TileDataServiceClientMonitor>() {
    ...
    public TileDataServiceClientMonitor load(@Nonnull BlockPos pos) {
      ...
      return new TileDataServiceClientMonitor(() -> AthenaeumConfig.CLIENT.tileDataServiceUpdateIntervalTicks.get(), TOTAL_INTERVAL_COUNT);
    }
  };
  ...
  static {
    ...
    TOTAL = new TileDataServiceClientMonitor(() -> AthenaeumConfig.CLIENT.tileDataServiceUpdateIntervalTicks.get(), TOTAL_INTERVAL_COUNT);
  ...
  public static void onEvent(TickEvent.ClientTickEvent event) {
    ...
    if (event.phase == TickEvent.Phase.START) {
      ...
      if (!Minecraft.getInstance().isGamePaused()
          && AthenaeumConfig.CLIENT.tileDataServiceEnabled.get()) {
        TOTAL.update();
  ...
  public static void onClientPacketReceived(TileDataTracker tracker, BlockPos pos, int size) {
    ...
    if (AthenaeumConfig.CLIENT.tileDataServiceEnabled.get()) {
